...
<body  <?php body_class(); ?>>
	...
	<header class="header sticky-tops">
		...
		<!--/ End Main Menu -->
		<!-- Header Inner -->
		<?php if (  display_header_text() || has_header_image() || get_theme_mod('color_newsmagazine_sitetitle_google','1') > 0 ) : ?>
		<div  class="header-inner">
			<div class= " background-cu-header " style="background: url(<?php echo esc_url(get_header_image());?>)">
				<div class="container <?php if(display_header_text() || has_header_image() || get_theme_mod('color_newsmagazine_sitetitle_google','1') > 0 ) { echo 'header-padding';}; ?>
